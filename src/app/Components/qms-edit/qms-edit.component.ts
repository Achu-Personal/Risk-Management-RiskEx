...
@Component({
  ...
  standalone: true,
  imports: [EditTextAreaComponent, DropdownComponent, FormsModule, ReactiveFormsModule, TextareaComponent, OverallRatingCardComponent, CommonModule, BodyContainerComponent],
...
export class QmsEditComponent {
  ...
  toggleEdit(field: 'isEditableDetails' | 'isEditableManagement'): void {
